...
export class AuthService {
  private apiUrl = 'http://easy2drive.free.nf/phprestAPI/login.php'; // URL de l'API
  ...
  getEleveInfo() {
    ...
    return this.http.get(`http://easy2drive.free.nf/phprestAPI/eleve/eleve.php?id=${userId}`);
  }
